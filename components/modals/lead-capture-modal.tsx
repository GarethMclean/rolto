...
export default function LeadCaptureModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="mx-2 max-h-[95vh] overflow-y-auto rounded-2xl border-0 bg-white p-0 shadow-2xl w-[calc(100vw-16px)] sm:mx-0 sm:max-w-md sm:w-auto sm:rounded-xl sm:border sm:p-6">
        {isSuccess ? (
