    ...
    <section className="bg-background py-16 sm:py-24 md:py-32">
      <MaxWidthWrapper>
        ...
        <p className="mt-4 text-balance text-sm text-muted-foreground sm:mt-6 sm:text-base md:text-lg">
          ...
          See the real benefits teams are experiencing.
        </p>

        <div className="relative z-10 mt-12 grid grid-cols-6 gap-2 sm:mt-16 sm:gap-3">
          ...
          <div className="relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-4 sm:p-6 md:p-8 lg:col-span-2">
            <div className="relative m-auto size-fit">
              <div className="relative flex h-16 w-40 items-center sm:h-20 sm:w-48 md:h-24 md:w-56">
                <svg
                ...
                <span className="text-gradient_indigo-purple mx-auto block w-fit font-heading text-3xl sm:text-4xl md:text-5xl">
                  300%
                </span>
              </div>
              <h2 className="mt-4 text-center font-heading text-xl sm:mt-6 sm:text-2xl md:text-3xl lg:text-4xl">
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-4 sm:col-span-3 sm:p-6 md:p-8 lg:col-span-2">
            <div>
              <div className="relative mx-auto flex aspect-square size-20 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border before:bg-muted/20 dark:before:border-white/5 sm:size-24 md:size-28 lg:size-32">
                <svg
                  className="m-auto h-fit w-16 sm:w-20 md:w-24"
                  viewBox="0 0 212 143"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <div className="relative z-10 mt-4 space-y-1 text-center sm:mt-6 sm:space-y-1.5 md:mt-8">
                <h2 className="text-sm font-medium text-foreground sm:text-base md:text-lg">
                  Instant Engagement
                </h2>
                <p className="text-xs text-muted-foreground sm:text-sm md:text-base">
                  Engage visitors immediately with intelligent conversations
                  that guide them through your funnel.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  Track conversations, identify opportunities, and optimize your
            ...
            <div className="grid sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Add conversational AI to your website with a single line of
                    JavaScript. No complex integrations needed.
                  </p>
                </div>
              </div>
              <div className="relative -mb-10 -mr-10 mt-8 h-fit rounded-tl-xl border bg-muted/30 pt-6 sm:ml-6 sm:mt-auto">
                ...
                <div className="p-4 font-mono text-sm">
                  ...
                  <br />
                  <span className="text-blue-600">rolto</span>.
                  <span className="text-purple-600">init</span>({"{"}
                  <br />
                  &nbsp;&nbsp;<span className="text-orange-600">
                    apiKey
                  </span>: <span className="text-green-600">&apos;your-key&apos;</span>
                  <br />
                  {"}"});
                  <br />
                  <span className="text-green-600">&lt;/script&gt;</span>
            ...
            <div className="grid h-full sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Escalate to your team when AI needs help or you prefer human
                    oversight for complex conversations.
                  </p>
                </div>
              </div>
                ...
                <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                  <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                    ...
                    <div className="size-7 ring-4 ring-background">
                      <div className="flex size-full items-center justify-center rounded-full border bg-gradient-to-br from-purple-500 to-indigo-600 text-xs font-bold text-white">
                        AI
                      </div>
                    </div>
                  </div>
